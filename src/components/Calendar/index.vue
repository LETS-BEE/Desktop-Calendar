<template>
  <div id='calendar'>
    <div class='uk-button-group calendar-head-left'> 
      ...
      <button class='uk-button uk-button-small' :class="['uk-button-' + getCalendarOption.buttonType]" uk-tooltip="'Event 추가'" ref="addEventBtn" @click='showAdd = true'  @mouseover="setIgnore" @mouseout="disableIgnore">
        <span uk-icon='plus' />
      </button>
      <div uk-drop='mode: click' ref="eventAddDrop" id="test">
        <div class='uk-card uk-card-default uk-padding-small event-add' @mouseover="setIgnore" @mouseout="disableIgnore">
          <fieldset class='uk-fieldset'>
            ...
            <button class="uk-button uk-button-small" :class="['uk-button-' + getCalendarOption.buttonType]" :uk-tooltip="[startTime ? '이벤트를 추가합니다.' : '시작 시간을 정해 주십시오.']" @click='insertEvent' :disabled="!startTime">추가</button>
          </fieldset>
        </div>
      </div>
      <button class="uk-button uk-button-small" :class="['uk-button-' + getCalendarOption.buttonType]" uk-tooltip="'Calendar을 움직입니다.'" @mouseover="setIgnore" @mouseout="disableIgnore">
        <span uk-icon='move' style='-webkit-app-region: drag;' />
      </button>
    </div>
    <div class='uk-button-group calendar-head-right' @mouseover="setIgnore" @mouseout="disableIgnore">
      ...
      <button class='uk-button uk-button-small' :class="['uk-button-' + getCalendarOption.buttonType]" @click='Fcalendar.today();reloadEvent();'><span uk-icon='clock'/></button>
